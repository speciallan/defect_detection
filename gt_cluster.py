...
from taurus_cv.models.faster_rcnn.io.input import VocDetectionDataset
...
from defect_detection.config import current_config as config
...
if __name__ == '__main__':
    ...
    parse.add_argument("--clusters", type=int, default=10, help="cluster num")
